  ...
  void updateUI(dynamic weatherData) {
    setState(() {
      if (weatherData != 'null') {
        ...
        int humidityValue = weatherData['main']['humidity'];
        humidity = humidityValue;
        double windSpeedValue = double.parse(weatherData['wind']['speed'].toString());
        windSpeed = windSpeedValue;
      }else{
        cityName = "Wrong!Give Right City Name.";
      }
    });
  }
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        '$temperature°c',
                        style: kTempTextStyle.copyWith(fontSize: 75.0)
                      ),
                    ),
                    GestureDetector(
                      onTap: () async {
